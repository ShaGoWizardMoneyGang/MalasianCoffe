...
func NewMultiplePacketReceiver(identifier string, transformer func(accumulated_input string, new_input string) string) MultiplePacketReceiver {
...
// Funcion que destruye todos los archivos creados por el MultiplePacketReceiver
...
func (pr *MultiplePacketReceiver) flushWindow() {
...
func (pr *MultiplePacketReceiver) checkIfInWindow(pkt packet.Packet) bool {
	is_in := false
...
func (pr *MultiplePacketReceiver) checkIfReceivedAll() bool {
...
func (pr *MultiplePacketReceiver) writePartialWork(input string, ventana []int) {
...
func (pr *MultiplePacketReceiver) serialize_partial_work(partial_work partialWork) string {
...
func (pr *MultiplePacketReceiver) read_partial_work() partialWork {
