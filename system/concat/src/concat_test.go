package concat
// NOTE(fabri): Este test lo comento porque falla y creo que esta mal.
// El concat no deberia devolver parcialmente el resultado acumulado, sino que
// deveria devolver todo lo acujulado cuando le llegue todo.
// Construyendo el paquete a mano va a dejar valores no inicializados, lo cual
// va a producir que la funcion no valide correctamente el fin de la llegada de
// paquetes.
